      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">Secondary (DEFAULT)</p>
          </div>
          <div className="space-y-2">
            <div className="h-16 bg-accent rounded-lg"></div>
            <p className="text-sm text-muted-foreground">Accent (DEFAULT)</p>
          </div>
          <div className="space-y-2">
        ...
        <div className="space-y-4 mt-8">
          ...
          <div className="space-y-6">
            {/* Primary Colors */}
            <div className="space-y-2">
              <h4 className="text-lg font-medium text-foreground">Primary Colors</h4>
              <div className="grid grid-cols-3 md:grid-cols-6 gap-2">
                ...
                <div className="space-y-1">
                  <div className="h-12 bg-primary-300 rounded"></div>
                  <p className="text-xs text-center">300</p>
                </div>
                <div className="space-y-1">
                  <div className="h-12 bg-primary-400 rounded"></div>
                  <p className="text-xs text-center">400</p>
                </div>
                <div className="space-y-1">
                  <div className="h-12 bg-primary rounded border-2 border-foreground"></div>
                  <p className="text-xs text-center font-bold">DEFAULT</p>
                </div>
                <div className="space-y-1">
                  <div className="h-12 bg-primary-600 rounded"></div>
            ...
            {/* Secondary Colors */}
            <div className="space-y-2">
              <h4 className="text-lg font-medium text-foreground">Secondary Colors</h4>
              <div className="grid grid-cols-3 md:grid-cols-6 gap-2">
                <div className="space-y-1">
                ...
                <div className="space-y-1">
                  <div className="h-12 bg-secondary-300 rounded"></div>
                  <p className="text-xs text-center">300</p>
                </div>
                <div className="space-y-1">
                  <div className="h-12 bg-secondary-400 rounded"></div>
                  <p className="text-xs text-center">400</p>
                </div>
                <div className="space-y-1">
                  <div className="h-12 bg-secondary rounded border-2 border-foreground"></div>
                  <p className="text-xs text-center font-bold">DEFAULT</p>
                </div>
                <div className="space-y-1">
                  <div className="h-12 bg-secondary-600 rounded"></div>
                  <p className="text-xs text-center">600</p>
                </div>
                <div className="space-y-1">
            ...
            {/* Accent Colors */}
            <div className="space-y-2">
              <h4 className="text-lg font-medium text-foreground">Accent Colors</h4>
              <div className="grid grid-cols-3 md:grid-cols-6 gap-2">
                <div className="space-y-1">
                  <div className="h-12 bg-accent-200 rounded"></div>
                  <p className="text-xs text-center">200</p>
                </div>
                <div className="space-y-1">
                  <div className="h-12 bg-accent-300 rounded"></div>
                  <p className="text-xs text-center">300</p>
                </div>
                <div className="space-y-1">
                  <div className="h-12 bg-accent-400 rounded"></div>
                  <p className="text-xs text-center">400</p>
                </div>
                <div className="space-y-1">
                  <div className="h-12 bg-accent rounded border-2 border-foreground"></div>
                  <p className="text-xs text-center font-bold">DEFAULT</p>
                </div>
                <div className="space-y-1">
                  <div className="h-12 bg-accent-600 rounded"></div>
                  <p className="text-xs text-center">600</p>
                </div>
                <div className="space-y-1">
                  <div className="h-12 bg-accent-700 rounded"></div>
                  <p className="text-xs text-center">700</p>
                </div>
              </div>
            </div>
