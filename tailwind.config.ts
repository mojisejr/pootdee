...
const config: Config = {
  ...
  darkMode: "selector", // Enable dark mode with selector strategy for next-themes compatibility
  theme: {
    extend: {
      colors: {
        // Base colors
        ...
        primary: {
          ...
          300: "var(--primary-300)",
          400: "var(--primary-400)",
          500: "var(--primary-500)", // Main orange #f37324
          600: "var(--primary-600)",
          700: "var(--primary-700)",
          800: "var(--primary-800)",
          900: "var(--primary-900)",
        ...
        secondary: {
          ...
          500: "var(--secondary-500)", // Main navy #002852
        ...
        accent: {
          ...
          300: "var(--accent-300)",
          400: "var(--accent-400)",
          500: "var(--accent-500)", // Main green #54b141
          600: "var(--accent-600)",
          700: "var(--accent-700)",
          800: "var(--accent-800)",
          900: "var(--accent-900)",
